      ...
      <ScrollView style={styles.reminders}>
        <View style={styles.reminders_body}>
          ...
          <View style={styles.reminders_toggle}>
            <Text style={styles.reminders_toggle_label}>
            ...
            <View style={styles.reminders_toggle_spinner}>
              ...
              <Toggle
                style={styles.reminders_toggle_cb}
                value={status}
                disabled={disabled}
          ...
          <View>
            <View style={[styles.reminders_toggle, styles.lineTop]}>
              ...
              <CheckBox
                ...
                onValueChange={(newValue) =>
                  handleChangeType({type_reminder: !config.type_reminder})
                }
              />
            </View>
            <View style={{opacity: reminderActive ? 1 : 0.5}}>
              <Text style={styles.reminders_description}>
                ...
                <Text style={styles.reminders_description_duration}>
                  the day before
                </Text>{' '}
                your collection day.
              </Text>
              <View style={styles.reminders_picker}>
                <Text style={styles.reminders_picker_label}>
                  Set Reminder Time
                </Text>
                <TouchableOpacity
                  style={styles.reminders_picker_selector}
                  onPress={showPicker}
                  activeOpacity={0.8}>
                  <Text style={remindersPickerTimeStyle}>
                    {formatTime(date)}
                  </Text>
                  <Text>
                    <Icon
                      ...
                      size={16}
                      color={
                        disabled || !reminderActive ? '#e0e0e0' : '#616161'
                      }
                    />
                  </Text>
                </TouchableOpacity>
              ...
              <Text style={styles.reminders_description}>
                Reminders will be sent on the hour. Any time set will default to
                the nearest hour.
              </Text>
            </View>
          </View>
          <View>
            <View style={[styles.reminders_toggle, styles.lineTop]}>
              ...
              <CheckBox
                ...
                value={serviceActive}
                onValueChange={(newValue) =>
                  handleChangeType({type_service: !config.type_service})
                }
              />
            </View>
            <View style={{opacity: serviceActive ? 1 : 0.5}}>
              <Text style={styles.reminders_description}>
                Receive push notifications for emergencies, changes, and events
                related to your bin collection service.
              </Text>
            </View>
          </View>
        </View>
        ...
        {false && (
          ...
          /> */}
            <TimePicker
              time={format(date, 'HHmm', {timeZone: 'Australia/Melbourne'})}
        ...
        {show && status && (
          <Modal animationType="fade" transparent visible={modal}>
            <View style={styles.reminders_modal}>
              ...
              <TouchableOpacity
                style={styles.reminders_modal_button}
