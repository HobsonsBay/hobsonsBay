...
const Contact: React.FC<IContact> = ({navigation, route}) => {
        ...
        <ScrollView
          ...
          <View style={styles.about_links}>
            <LinkTile
              icon="custService"
              onPress={() => {
                Linking.openURL(`tel:1300 179 944`);
              }}>
            ...
            <LinkTile
              icon="liveChat"
              onPress={() => {
                Linking.openURL(`http://webchat.hobsonsbay.vic.gov.au/`);
              }}>
            ...
            <LinkTile
              icon="relayService"
              onPress={() => {
                Linking.openURL(`tel:133 677`);
              }}>
              Call National Relay Service
              <Br />
              133 677
            </LinkTile>
            <LinkTile
              icon="langLine"
              onPress={() => {
                Linking.openURL(`tel:03 9932 1212`);
              }}>
              Speak with us in your community language
              <Br />
              03 9932 1212
            </LinkTile>
            <LinkTile
              ...
              onPress={() => {
                openMap({
                  query: '115 Civic Parade, Altona VIC 3018',
                  zoom: 17,
                });
              }}>
              Visit our customer service front counter
              <Br />
              <Br />
              115 Civic Parade
              <Br />
